...
const comparisonData = [
  {
    ...
    description:
      "We perform a comprehensive audit and develop AI strategies specifically addressing your business's operational loopholes.",
  },
  {
    us: "Risk-Free Satisfaction Guarantee",
    them: "Risky Contracts, No Guarantees",
    description:
      "Full refund if we don't meet agreed-upon KPIs—no questions asked.",
  },
  {
    us: "Cutting-Edge Industry Technology",
    them: "Outdated Technology Stacks",
    description:
      "Our solutions leverage the latest advancements, ensuring your business stays ahead of the curve.",
  },
  {
    us: "Comprehensive Multilingual Support",
    them: "Limited Language Capabilities",
    description:
      "AI agents fluent in English, Spanish, Chinese, and more, with custom language requests fully accommodated.",
  },
  {
    us: "Eliminate Operational Bottlenecks",
    them: "Persistent Operational Inefficiencies",
    description:
      "Streamline efficiency by automating repetitive tasks and removing time-draining busywork.",
  },
  {
    us: "Significant Cost & Time Savings",
    them: "Hidden Costs & Wasted Resources",
    description:
      "Reduce unnecessary expenditures and inefficiencies through intelligently designed automation solutions.",
  },
  {
    us: "Seamless System Integration",
    them: "Poor Integration Support",
    description:
      "We integrate directly into your existing CRMs, calendars, support systems, and internal tools—no need to change your tech stack.",
  },
];
                      ...
                      <div className="rounded-lg overflow-hidden">
                        ...
                        <AnimatePresence>
                          {open && (
                            ...
                            >
                              <div className="p-4 bg-slate-50 text-sm text-slate-600">
                                Lack deep understanding of your unique
                                operational challenges and provide generic
                                solutions that don't address your specific
                                needs.
                              </div>
                            </Disclosure.Panel>
                          )}
