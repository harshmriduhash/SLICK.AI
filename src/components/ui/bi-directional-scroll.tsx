...
export function BiDirectionalScroll() {
  ...
  return (
    ...
    >
      ...
      <motion.div className="w-[80%] mx-auto" style={{ opacity }}>
        ...
        <div className="relative overflow-hidden mb-6">
          ...
          >
            {duplicatedWords.map((word, idx) => (
              ...
              >
                <div
                  className={`px-6 py-3 rounded-2xl bg-white shadow-lg backdrop-blur-sm bg-opacity-80 
                  border border-slate-200 transition-all duration-300
                  group-hover:shadow-xl group-hover:border-slate-300`}
                >
                  <span
                    className={`text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${word.gradient}`}
                  >
                    {word.text}
                  </span>
                </div>
